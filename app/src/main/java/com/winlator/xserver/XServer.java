...
public class XServer {
    ...
    private Object winHandler; // WinHandler stub
    private final EnumMap<Lockable, ReentrantLock> locks = new EnumMap<>(Lockable.class);
    private boolean relativeMouseMovement = false;

    public XServer(android.content.Context context, ScreenInfo screenInfo) {
    ...
    public Object getWinHandler() { return winHandler; }
    public void setWinHandler(Object winHandler) { this.winHandler = winHandler; }
